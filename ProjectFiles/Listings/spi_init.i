...
# 33 "./SPL/MDR32Fx/inc\\MDR32F9Qx_ssp.h" 2
...
void Setup_SPI(void)
{
 PORT_InitTypeDef Port_sruct;
    ...
    RST_CLK_PCLKcmd((((uint32_t)(1U << ((((uint32_t)(0x40020000)) >> 15) & 0x1F))) | ((uint32_t)(1U << ((((uint32_t)(0x40040000)) >> 15) & 0x1F)))), ENABLE);
    RST_CLK_PCLKcmd((((uint32_t)(1U << ((((uint32_t)(0x400B0000)) >> 15) & 0x1F))) | ((uint32_t)(1U << ((((uint32_t)(0x400E8000)) >> 15) & 0x1F)))), ENABLE);


 PORT_StructInit(&Port_sruct);
 Port_sruct.PORT_Pin = (PORT_Pin_6 | PORT_Pin_7);
