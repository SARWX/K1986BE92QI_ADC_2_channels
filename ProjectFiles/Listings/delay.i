# 1 "CustomLibs/inc/delay.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 379 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "CustomLibs/inc/delay.c" 2
# 27 "CustomLibs/inc/delay.c"
# 1 "./CustomLibs/inc/defines.h" 1
# 28 "CustomLibs/inc/delay.c" 2
...
{
 delay_tick(delay * (16000000 / (1000 * 10)));
}

void delay_us(uint32_t delay)
{
 delay_tick(delay * (16000000 / (1000000 * 10)));
}
