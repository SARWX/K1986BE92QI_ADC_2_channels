...
class qpsk_stage6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_1_0_0_0 = epy_block_1_0_0_0.blk(example_param=1.0)
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff(0.01)
        ...
        self.connect((self.epy_block_1_0_0, 0), (self.epy_block_1_0_0_0, 0))
        self.connect((self.epy_block_1_0_0, 1), (self.epy_block_1_0_0_0, 1))
